                        ...
                        <tbody>
                            ...
                            >
                                <td class="p-4">
                                    ...
                                    <img
                                        v-else
                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjgEfZJgjzWVC_m-mXFS3dQXeysk4oQ-tLaDXpxic2dw&s"
                                        class="w-16 md:w-32 max-w-full max-h-full"
                                        alt="Apple Watch"
                                    />
                                </td>
...
import UserLayouts from "./Layout/UserLayouts.vue";
